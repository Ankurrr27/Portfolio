    ...
    <div className="min-h-screen bg-slate-50 dark:bg-zinc-950 flex text-slate-800 dark:text-zinc-100 font-sans">
      ...
      `}>
        <div className="p-6 flex-1 flex flex-col">
          <div className="flex items-center gap-3 mb-10 pl-2">
             <div className="w-8 h-8 rounded-md bg-indigo-500 flex items-center justify-center text-white font-bold shadow-sm">A</div>
                ...
                <Link
                  ...
                  className={`
                    ...
                    ${isActive 
                      ...
                      : "text-slate-600 dark:text-zinc-400 hover:text-indigo-600 hover:bg-slate-50 dark:hover:bg-zinc-900"}
                  `}
                >
                  <div className="flex items-center gap-3">
                    <item.icon size={16} className={isActive ? "text-indigo-600 dark:text-indigo-400" : "text-slate-400 group-hover:text-indigo-600 transition-colors"} />
      ...
      <div className="flex-1 flex flex-col min-w-0 lg:pl-64">
        ...
        <header className="lg:hidden flex items-center justify-between p-4 bg-white dark:bg-zinc-950 border-b border-slate-200 dark:border-zinc-800">
           <div className="flex items-center gap-3">
             <div className="w-8 h-8 rounded-md bg-indigo-500 flex items-center justify-center text-white font-bold">A</div>
