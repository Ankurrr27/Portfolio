          ...
          <div className="md:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-6">
            <div className="space-y-3">
              ...
              <ul className="space-y-2">
                {["Home", "Projects", "Achievements", "Skills"].map((link) => (
                  <li key={link}>
                    <a href={`#${link.toLowerCase()}`} className="text-zinc-500 hover:text-amber-500 transition-colors text-sm font-medium">
                      {link}
                    </a>
                  </li>
                ))}
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a href="/admin" className="text-zinc-500 hover:text-amber-500 transition-colors text-sm font-medium">
                    Admin Portal
                  </a>
                </li>
              </ul>
